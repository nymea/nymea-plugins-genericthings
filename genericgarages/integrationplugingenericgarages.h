...
#ifndef INTEGRATIONPLUGINGENERICGARAGES_H
#define INTEGRATIONPLUGINGENERICGARAGES_H
...
class IntegrationPluginGenericGarages: public IntegrationPlugin
{
    Q_OBJECT

    Q_PLUGIN_METADATA(IID "io.nymea.IntegrationPlugin" FILE "integrationplugingenericgarages.json")
    Q_INTERFACES(IntegrationPlugin)

public:
    explicit IntegrationPluginGenericGarages();
...
#endif // INTEGRATIONPLUGINGENERICGARAGES_H
