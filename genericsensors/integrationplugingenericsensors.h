...
#ifndef INTEGRATIONPLUGINGENERICSENSORS_H
#define INTEGRATIONPLUGINGENERICSENSORS_H
...
class IntegrationPluginGenericSensors: public IntegrationPlugin
{
    Q_OBJECT

    Q_PLUGIN_METADATA(IID "io.nymea.IntegrationPlugin" FILE "integrationplugingenericsensors.json")
...
#endif // INTEGRATIONPLUGINGENERICSENSORS_H
